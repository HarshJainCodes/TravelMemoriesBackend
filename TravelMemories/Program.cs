...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://localhost:5173", "http://192.168.1.4:5173", "https://memories.harshjain17.com", "https://lemon-moss-0ef6b9200.4.azurestaticapps.net", "https://harshjain17.com").AllowAnyHeader().AllowAnyMethod().AllowCredentials();
    });
});
